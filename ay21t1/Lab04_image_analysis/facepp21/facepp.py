...
from facepp21.structures import ObjectDict
from facepp21.compat import (basestring, str, numeric_types, enc, choose_boundary,
...
API_KEY = "Q1Uss2fxzQ3jdt6Twa1ADnk_uPnBQjRQ"
API_SECRET = "Dn2yDm1SijGpoxBlib30cAahzsw98Y-j"
...
class API(object):
    ...
    def __init__(self, api_key, api_secret):        
        ...
        if len(api_key)==0 or len(api_secret)==0:
            print('\n'+'ERROR'+os.path.realpath(__file__)+'Please provide key and secret'+'\n')
            exit(1)
